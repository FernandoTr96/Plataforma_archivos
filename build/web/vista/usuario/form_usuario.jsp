...
<main class="main_form_usuario">
    <form action="<%out.print(BASE_URL);%>/usuario?action=guardar_usuario" method="POST" id="form_usuario"  autocomplete="nope" enctype="multipart/form-data">
        ...
        <div class="form_group input-nombre">
            ...
            title="*No se admiten caracteres o números">
        ...
        <div class="form_group input-correo">
            ...
            title="*La estructura debe ser correcta">
